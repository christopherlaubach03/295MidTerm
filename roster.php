<?php
 ...
 $players = [];
 $sql = "SELECT id, stats_target_id, image_src, image_alt, position_info, player_number_name, pro_info, stats_games, stats_ppg, stats_rpg, stats_apg FROM players ORDER BY player_number_name ASC"; // Or your preferred order
...
<head>
  ...
  <title>Detroit Pistons Roster (Database)</title>
...
<body>
  ...
  <main>
    <h1>2024-25 Men's Basketball Roster (Database Driven)</h1>
        ...
        <tbody>
          <?php if (!empty($players)): ?>
              <?php foreach ($players as $player): ?>
                <tr>
                  <td>
                    <img src="<?php echo e($player['imageSrc']); ?>" alt="<?php echo e($player['imageAlt']); ?>">
                  </td>
                  <td>
                    <p><?php echo e($player['positionInfo']); ?></p>
                    <h2><?php echo e($player['playerNumberName']); ?></h2>
                    <p><?php echo e($player['proInfo']); ?></p>
                    <button class="stats-button" data-target="<?php echo e($player['statsTargetId']); ?>">
                        <img src="images/White Statistics Icon (2).png" alt="Show Stats">
                    </button>
                  </td>
                </tr>
                <tr class="stats-row" id="<?php echo e($player['statsTargetId']); ?>">
                  <td colspan="2">
